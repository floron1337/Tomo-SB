...
const Messages = ({
  ...
  return (
    <div className="flex flex-col max-md:basis-full justify-between basis-2/3 h-full max-w-[48rem] bg-foreground w-auto">
      <div className="flex flex-row h-[6rem] justify-between w-full p-3 border-b-2 border-secondary border-opacity-50">
        ...
        <Link href="/" className=" my-auto text-white md:hidden">
