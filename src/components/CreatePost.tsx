      ...
      {showCreate ? (
        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          <div className="flex flex-row items-center">
            ...
            <Input
              className="bg-background border-secondary text-white w-1/2"
              type="text"
              name="title"
            />
          </div>
          <div>
            ...
            <textarea
              className="bg-background text-white min-h-32 w-full items-start justify-start border border-secondary rounded-xl"
              name="description"
            />
          </div>
          <FileUpload
          ...
          />
          <Button
            className="w-1/4 ml-auto mr-auto bg-background hover:bg-accent-foreground"
            type="submit"
            disabled={loading}
          >
            Create Post
