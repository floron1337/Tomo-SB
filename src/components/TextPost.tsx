...
const TextPost = ({
  ...
  return (
    <div className="flex flex-row w-2/3 max-w-[46rem] min-w-96 h-auto bg-foreground pr-4 pl-1 py-4 rounded-2xl">
      <div className="h-auto flex flex-col gap-0 align-top justify-start ml-2 w-2/4 max-w-24 min-w-20 h-2/3">
      ...
      <div className="flex flex-col">
        <p className="text-secondary-foreground p-1">{content}</p>
