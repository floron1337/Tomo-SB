'use client'
import { Ellipsis, Forward, Heart, MessageSquareMore, Trash, UsersRound } from "lucide-react";
...
const TextPost = ({
  ...
  return (
    <div className="flex flex-row w-full max-w-[46rem] min-w-96 min-h-[10rem] h-auto bg-foreground pr-4 pl-1 py-4 rounded-2xl">
      ...
      <Button className='bg-destructive hover:bg-red-600 p-2' onClick={deletePost}>
        <Trash/>
      </Button>
    </div>
  );
